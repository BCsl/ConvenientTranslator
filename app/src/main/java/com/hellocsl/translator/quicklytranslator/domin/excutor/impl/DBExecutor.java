 ...
 */
public class DBExecutor implements ThreadExecutor {
    ...
    public DBExecutor() {
        ...
        this.threadFactory = new DBThreadFactory();
    ...
    private static class DBThreadFactory implements ThreadFactory {
        private static final String THREAD_NAME = "android_db_";
